...
parser.add_argument(
    "--model-name",
    type=str,
    help="model name (beta_vae, beta_tcvae, factor_vae, info_vae, dip_vae)",
)

parser.add_argument("--beta", type=str, help="beta factor for beta_vae")
parser.add_argument(
    "--tc-loss-factor", type=str, help="tc_loss_factor for beta_tcvae"
)
parser.add_argument(
    "--d-tc-loss-factor", type=str, help="d_tc_loss_factor for factor_vae"
)
parser.add_argument("--lambd", type=str, help="lambd for info_vae")
parser.add_argument("--dip-type", type=str, help="dip_type for dip_vae")
parser.add_argument("--lambda-od", type=str, help="lambda_od for dip_vae")
...
if __name__ == "__main__":
    if args.config_file is not None:
        ...
        with open(config_dir / "config_for_vae.yaml", "r") as vae_config_file:
            vae_config = Box(yaml.safe_load(vae_config_file))[args.model_name]
